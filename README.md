...
![Jan Suraksha Agent Architecture](dev/screenshots/agent-design.png)
...
![Train Search](dev/screenshots/train-search.png)
...
![Train Results](dev/screenshots/train-results.png)
...
![Jan Suraksha Chat](dev/screenshots/bot-chat.png)
...
![Complaint Filed](dev/screenshots/bot-complaint-filed.png)
...
![FIR Template](dev/screenshots/bot-fir-template.png)
...
![Police Dashboard](dev/screenshots/police-tickets.png)
...
![Police Analytics](dev/screenshots/police-analytics.png)
...
![Email Notification](dev/screenshots/email-notification.png)
...
![Neo4j Graph](dev/screenshots/neo4j-graph.png)
